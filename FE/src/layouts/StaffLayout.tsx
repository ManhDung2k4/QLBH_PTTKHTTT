...
const StaffLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-white relative flex">
      {/* Teal Glow Background for Staff */}
      <div
      ...
      >
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          >
            <MdPeople size={20} />
            {sidebarOpen && (
              <span className="font-medium">Tra cứu khách hàng</span>
            )}
          </NavLink>
          ...
          >
            <MdReceipt size={20} />
            {sidebarOpen && (
              <span className="font-medium">Quản lý hóa đơn</span>
            )}
          </NavLink>
        </nav>
      ...
      >
        ...
        <footer className="bg-white/60 backdrop-blur-sm border-t border-teal-200/50 py-4 px-6">
          <div className="text-center text-gray-600 text-sm">
            &copy; 2025 PhoneStore - Hệ thống quản lý bán hàng
          </div>
        </footer>
      </div>
    </div>
