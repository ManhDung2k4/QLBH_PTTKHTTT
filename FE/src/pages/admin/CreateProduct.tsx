    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">Điền thông tin sản phẩm</p>
        </div>
      </div>
          ...
          <div className="space-y-6">
            <div className="bg-white border-2 border-gray-200 rounded-xl p-6 space-y-4 shadow-sm">
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  onChange={handleChange}
                  className="w-5 h-5 rounded border-2 border-gray-300 text-teal-600 focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500"
                />
                <div>
            ...
            <div className="space-y-3">
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-teal-500 to-teal-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-teal-600 hover:to-teal-700 shadow-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <MdSave size={20} />
